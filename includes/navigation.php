               ...
               <div class="collapse navbar-collapse" id="navbarNavDropdown">
                  <ul class="navbar-nav">
                     ...
                     <li class="nav-item dropdown">
                        <a class="nav-link <?php if ($CURRENT_PAGE == "Contact") {?>active<?php }?>" href="#">О компании<i class="fas fa-angle-down"></i></i></a>
                        ...
                        <ul class="dropdown-menu dropdown-menu-left">
                           ...
                           <li class="dropdown-submenu">
                              <a class="dropdown-item" href="#">Акционерам<i class="fas fa-angle-down"></i></a>
                     ...
                     <li class="nav-item dropdown">
                        <a class="nav-link <?php if ($CURRENT_PAGE == "Contact") {?>active<?php }?>" href="#">Продукция<i class="fas fa-angle-down"></i> </a>
                        <ul class="dropdown-menu dropdown-menu-left">
                           <li  class="dropdown-submenu">
                              <a class="dropdown-item" href="#">Вина<i class="fas fa-angle-down"></i></a>
                              <ul class="dropdown-menu">
                           ...
                           <li class="dropdown-submenu">
                              <a class="dropdown-item" href="#">Коньяки<i class="fas fa-angle-down"></i></a>
                              <ul class="dropdown-menu">
                     ...
                     <li class="nav-item dropdown">
                        <a class="nav-link <?php if ($CURRENT_PAGE == "Contact") {?>active<?php }?>" href="#">Контакты<i class="fas fa-angle-down"></i> </a>
