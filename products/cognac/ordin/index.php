               ...
               <div class="col-lg-9">
                  ...
                  <section class="primary">
                     <div class="product-box">
                        <h3 class="product-title">Коньяк пятилетний «Домбай»</h3>
                     ...
                     <div class="product-box">
                        <h3 class="product-title">Коньяк трехлетний «Три звездочки»</h3>
                        <div class="product-info">
                           <div class="product-column_content">
                              <div class="product-column left">
                     ...
                     <div class="product-box">
                        <h3 class="product-title">Коньяк пятилетний «Пять звездочек»</h3>
                        <div class="product-info">
                           <div class="product-column_content">
                              <div class="product-column left">
